 ...
 * @email: bayecheikhgueye2@gmail.com
 ...
 Template Name: Devis Envoi Admin
...
$test_mail = wp_mail("bayecheikhgueye2@gmail.com", $subject, $header, $header);
/*$order_mail1 = wp_mail($vendor_email, $subject, $header, $header);
$order_mail2 = wp_mail($customer_email, $subject, $header, $header);*/
$order_mail3 = wp_mail($admin_email, $subject, $header, $header);
